...
Public Class WSmaquinaria
    ...
    <ScriptMethod(ResponseFormat:=ResponseFormat.Json, XmlSerializeString:=False)> <WebMethod(True)> _
    Public Function setUbicaciones(ByVal idEconomico As String, ByVal idOperador As String, ByVal idObra As String, ByVal fecha_alta As String, ByVal comentarios As String, ByVal idUsuario As String, ByVal Hodometro As String) As String
        Dim lsError As String = ""
        Dim oDB As New DB()
        Dim oResultado As New Resultado()

        If oDB.setUbicacion(idEconomico, idOperador, idObra, fecha_alta, comentarios, idUsuario, Hodometro, lsError) Then
            oResultado.dato = "S"
            oResultado.mensaje = ""
        Else
            oResultado.dato = "N"
